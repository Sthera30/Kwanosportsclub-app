...
function EditValues() {
    ...
    async function handle_update(e) {
        ...
        try {
            ...
            const res = await axios.put('https://fullstack-kwanosportsclub-app-backendd.onrender.com/updateValues', { id, valuesIcon, valuesTitle, valuesDescription })
    ...
    async function handle_fetch_values_by_id(id) {
        ...
        try {
            ...
            const res = await axios.get(`https://fullstack-kwanosportsclub-app-backendd.onrender.com/getValuesById?id=${id}`)
