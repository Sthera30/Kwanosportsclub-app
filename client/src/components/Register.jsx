...
function Register() {
    ...
    async function handle_registration(e) {
        ...
        try {
            ...
            const { data } = await axios.post(`https://fullstack-kwanosportsclub-app-backendd.onrender/register`, { name, email, password, confirmPassword }, { withCredentials: true })
                ...
                <form onSubmit={handle_registration}>
                    ...
                    <div className='heading-container'>
                        ...
                        <div className='heading-right'>
                            ...
                            <GiTennisBall className='tennisBall' />
                    ...
                    <p>Get ready to serve up some fun!</p>
