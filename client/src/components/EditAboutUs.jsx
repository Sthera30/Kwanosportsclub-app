...
function EditAboutUs() {
    ...
    async function handle_submit(e) {
        ...
        try {
            ...
            const res = await axios.put(`https://kwanosportsclub.co.za/updateAboutUs`, { id, aboutTitle, aboutDescription })
    ...
    async function handle_fetch_about_us_by_id(id) {
        ...
        try {
            ...
            const res = await axios.get(`https://kwanosportsclub.co.za/getAboutUsById?id=${id}`)
