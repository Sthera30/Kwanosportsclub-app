...
function TheTeam() {
    ...
    async function handle_fetch_team() {
        ...
        try {
            ...
            const res = await axios.get(`https://fullstack-kwanosportsclub-app-backendd.onrender.com/getAllTeam`)
    ...
    async function handle_remove(id) {
        ...
        try {
            ...
            const res = await axios.delete(`https://fullstack-kwanosportsclub-app-backendd.onrender.com/removeTeam?id=${id}`)
